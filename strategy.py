...
print("Fetching SPY 1-minute bars for 2026-05-05...")

spy = yf.download("SPY", start="2026-05-05", end="2026-05-06", interval="1m", progress=False)
...
if spy.empty:
    ...
    # Save to CSV
    output_file = "spy_session_2026-05-05.csv"
