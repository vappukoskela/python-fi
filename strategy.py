...
print("Fetching SPY 1-minute bars for 2026-05-22...")

spy = yf.download("SPY", start="2026-05-22", end="2026-05-23", interval="1m", progress=False)
...
if spy.empty:
    ...
    # Save to CSV
    output_file = "spy_session_2026-05-22.csv"
