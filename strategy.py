...
print("Fetching SPY 1-minute bars for 2026-04-29...")

spy = yf.download("SPY", start="2026-04-29", end="2026-04-30", interval="1m", progress=False)
...
if spy.empty:
    ...
    # Save to CSV
    output_file = "spy_session_2026-04-29.csv"
